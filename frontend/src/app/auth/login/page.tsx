...
import { Mail, Lock, AlertCircle, ArrowRight, PlaneTakeoff, Loader2 } from "lucide-react";
...
export default function LoginPage() {
  ...
  const handleMockLogin = () => {
    ...
    // Trigger AuthContext update by reloading or redirecting
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-[#050505] selection:bg-indigo-500/30">
      {/* Background with animated gradients and blur */}
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-purple-600/20 rounded-full blur-[150px] mix-blend-screen" style={{ animationDelay: "2s" }} />
      ...
      >
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 p-8 rounded-3xl shadow-2xl overflow-hidden relative">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400 text-sm">Welcome back to your travel command center</p>
          </div>
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#0a0a0a] text-gray-500 backdrop-blur-xl">Or continue with</span>
              </div>
            </div>
